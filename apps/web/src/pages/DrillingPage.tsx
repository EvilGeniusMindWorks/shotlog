...
// S17 (Matthew): this is the plan queue and nothing else — rig checklists
// are filed from the day's rig list.
...
export function DrillingPage() {
  return (
    <div className="p-4 max-w-2xl mx-auto space-y-3 pb-24">
      ...
      {/* S17 (Matthew): the checklist door left — a rig checklist is filed from the day's rig list */}
      <DrillingWork />
    </div>
  );
}
