...
- `85` — Round S23 — Drilling over days: the pattern as a paper of the job, one drill log per pattern, the shot from the drilled pattern: The pattern as a paper of the job · the Drill plan tile · the +; One drill log per pattern · Continue · parts and signatures · rigs on every hole · Change rig; Drilled by itself · the blaster's home with the pace · Accept the drill log; The rig checklist as one screen · Complete needs start, stop and signature · the log's end of day waits for it; Friday · the shot from one pattern or several · the three doors; The shot's drilling card · the blasting log's lines · the drill log sheet; One flow · Records lines and the pattern node · older shots as filed.
