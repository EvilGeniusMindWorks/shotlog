async (page, lib) => {
  ...
  await R.section('public: the guide opens without signing in', async () => {
    ...
    // nine since the navigation round added "Finding your way around" (Sep 16 2026)
    R.ok('Start here lists its nine pages (What\'s new joined in S10, Finding your way around in the navigation round)', (await P0.locator('[data-help-page-link]').count()) === 9);
