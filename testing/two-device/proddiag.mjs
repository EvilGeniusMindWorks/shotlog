async (page) => {
  ...
  try {
    ...
    await ctx.addInitScript(`
      ...
      localStorage.setItem('shotlog-access-token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJmMDg5NGZhNi0xYTg0LTQ4ZmEtYjMxZi02Mjg5MzdmNjQ2NzciLCJjaWQiOiIwMDAwMDAwMC0wMDAwLTQwMDAtODAwMC0wMDAwMDAwMDAwMDEiLCJyb2xlIjoiYWRtaW4iLCJpYXQiOjE3ODUyNzM4NTIsImV4cCI6MTc4NTI4MTA1Mn0.4PIOHyjUkBqblvrtCQMicq7904nog3jjMeAbm-oXfqY');
